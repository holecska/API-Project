  ...
  # create and configure the app
    ...
    def create_new_question():
        ...
        try:
            if search:
                ...
                question = Question(answer=new_answer, category=new_category_id, difficulty=new_difficulty, question=new_question)
                question.insert()
    ...
    def get_questions_by_category(category_id):
        ...
        return jsonify({
            'success': True,
            'questions': current_questions,
            'total_questions': len(Question.query.order_by(Question.id).filter(Question.category == (category_id + 1)).all())
        })
    ...
    def quizzes():
        ...
        if category == -1:
            ...
            questions = Question.query.order_by(Question.id).filter(Question.category == (category_id + 1)).all()
